      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block mb-1 text-sm 3xl:text-lg 5xl:text-xl font-medium">Your Name *</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label className="block mb-1 text-sm 3xl:text-lg 5xl:text-xl font-medium">Your Email *</label>
                <input
                  type="email"
                  name="email"
                  value={formData.email}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block mb-1 text-sm 3xl:text-lg 5xl:text-xl font-medium">Contact</label>
                <input
                  type="text"
                  name="contact"
                  value={formData.subject}
              ...
              <div>
                <label className="block mb-1 text-sm 3xl:text-lg 5xl:text-xl font-medium">Service Desired</label>
                <select
                  name="service"
                  value={formData.service}
                  onChange={handleChange}
            ...
            <p className="text-xs 3xl:text-base 5xl:text-lg text-gray-600">
              ⚠ All the fields are required. By sending the form you agree to the{" "}
              <a href="#" className="text-blue-600 underline">Terms & Conditions</a> and{" "}
              <a href="#" className="text-blue-600 underline">Privacy Policy</a>.
            </p>
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-zinc-800 border-2 border-zinc-600 3xl:text-base 5xl:text-lg text-white px-6 py-3 rounded-full hover:bg-gray-800 transition-colors"
            >
              {loading ? "Sending..." : "SEND MESSAGE"}
            </button>
            {submitted && (
              <p className="text-orange-600 font-semibold">ᯓ➤ Message Sent Successfully!</p>
            )}
          </form>

          {/* Contact Info Section (unchanged) */}
          <div className="space-y-6 w-full">
            <h3 className="text-lg 3xl:text-xl 5xl:text-2xl font-bold">CONTACTS</h3>
            <p className="text-gray-600 3xl:text-base 5xl:text-lg ">
              Come visit us waiting for you in our office, let’s bring your idea to life!
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                <div className="bg-orange-400 text-white p-3 rounded-full 3xl:text-lg 5xl:text-xl">
                  <FaMapMarkerAlt />
                </div>
                <div>
                  <p className="3xl:text-base 5xl:text-lg">123 King Street, London W60 10250</p>
                  <p className="3xl:text-base 5xl:text-lg">United Kingdom</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-orange-400 text-white p-3 rounded-full 3xl:text-lg 5xl:text-xl">
                ...
                <div>
                  <p className="3xl:text-base 5xl:text-lg">support@example.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="bg-orange-400 text-white p-3 rounded-full 3xl:text-lg 5xl:text-xl">
                ...
                <div>
                  <p className="3xl:text-base 5xl:text-lg">+61 383 767 284</p>
                </div>
              </div>
            </div>
          </div>
